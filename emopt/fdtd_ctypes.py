...
libFDTD.FDTD_set_aux_arrays.argtypes = [c_void_p, \
                                        c_complex_p, c_complex_p, c_complex_p, \
                                        c_complex_p, c_complex_p, c_complex_p]
libFDTD.FDTD_set_aux_arrays.restype = None

libFDTD.FDTD_calc_phase.argtypes = [c_double, c_double, c_double, c_double]
libFDTD.FDTD_calc_phase.restype = c_double

libFDTD.FDTD_calc_amplitude.argtypes = [c_double, c_double, c_double, c_double, \
                                    c_double]
libFDTD.FDTD_calc_amplitude.restype = c_double

libFDTD.FDTD_capture_t0_fields.argtypes = [c_void_p]
libFDTD.FDTD_capture_t0_fields.restype = None

libFDTD.FDTD_calc_complex_fields.argtypes = [c_void_p, c_double, c_double]
libFDTD.FDTD_calc_complex_fields.restype = None
