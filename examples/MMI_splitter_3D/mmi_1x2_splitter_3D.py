...
leading to less unwanted scattering. The improvement you obtain by doing this
will be limited by the choice of output waveguide size and separation, however.
This behavior can be explored by choosing different starting MMI widths and
heights.
...
am.check_gradient(params, plot=False)
