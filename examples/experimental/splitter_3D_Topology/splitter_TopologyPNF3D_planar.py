...
class TopologyAM(TopologyPNF3D):
    def __init__(self, sim, mode_match, mm_line, domain=None, update_mu=False, eps_bounds=None, mu_bounds=None, planar=True, lam=0):
...
if __name__ == '__main__':
    ...
    ####################################################################################
    am = TopologyAM(sim, mode_match, mode_line, domain=optdomain, update_mu=False, eps_bounds=[eps_clad, eps_si], planar=True, lam=0.0)
    design_params = am.get_params()
    print(design_params.shape)
