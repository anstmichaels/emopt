"""Solve for the fundamental TE-like mode using electric symmetry.

On most *nix-based machines, run the script with:

    $ mpirun -n 8 python wg_modes_3D_sym_0E.py
...
strip = emopt.grid.Rectangle(W/2, 0.0, w_wg, h_SOI)
eps_bg = emopt.grid.Rectangle(W/2, 0.0, 2*W, 2*H)
